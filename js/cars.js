...
export function createAICar(startIdx, offset, color, id, name) {
    ...
    const currentGrip = cfg.weather === 'wet' ? 2.0 : 5.0; const wRadiusF = isMini ? 0.3 : 0.45; const wRadiusR = isMini ? 0.3 : 0.6;
    ...
    const fZ = isMini ? 0.9 : 1.85; const rZ = isMini ? -0.9 : -2.1; const width = isMini ? 0.7 : 1.1; const h = isMini ? 0.2 : 0.4;
